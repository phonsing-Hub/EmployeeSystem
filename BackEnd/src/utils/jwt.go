...
// 		if !ok {
// 			return c.Status(fiber.StatusInternalServerError).SendString("Failed to retrieve email")
// 		}

// resultJSON, err := json.Marshal(result)
// 		if err != nil {
// 			return c.Status(fiber.StatusInternalServerError).SendString("Failed to parse token claims")
// 		}